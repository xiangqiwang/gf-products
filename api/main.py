...
async def startup_event():
    ...
    try:
        ...
        # Pass 'sqlite' or let it use config
        await create_tables()
...
@app.get("/api/task_summary")
async def get_task_summary():
    """Get the summary of the last crawl task"""
    from tools.task_stats import task_stats
    return task_stats.get_summary()
...
if __name__ == "__main__":
    # Disable access logs to prevent polling spam
