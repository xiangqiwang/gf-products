...
async def parse_cmd(argv: Optional[Sequence[str]] = None):
    ...
    def main(
        ...
        start_date: Annotated[
            ...
            typer.Option(
                "--start_date",
                help="Start date for filtering posts (e.g., 2023-01-01)",
                rich_help_panel="Basic Configuration",
            ),
        ] = config.START_DATE,
        end_date: Annotated[
            ...
            typer.Option(
                "--end_date",
                help="End date for filtering posts (e.g., 2023-12-31)",
                rich_help_panel="Basic Configuration",
            ),
        ] = config.END_DATE,
        search_sort_type: Annotated[
            str,
            typer.Option(
                "--search_sort_type",
                help="Search sort type (general | latest | popular)",
                rich_help_panel="Global Configuration",
            ),
        ] = config.SEARCH_SORT_TYPE,
        ...
        config.SEARCH_SORT_TYPE = search_sort_type
